    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-16 sm:py-24">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-white/70 mb-8 leading-relaxed">
              Kwelps Album es tu álbum de fotos coleccionables digital.
              Colecta fotos de diferentes rarezas, fusiona cartas repetidas y
              completa colecciones para ganar premios increíbles.
            </p>
          ...
          <div className="mt-16 flex justify-center gap-4 flex-wrap">
            {[
              { rarity: 'Común', color: 'from-gray-500 to-gray-600', emoji: '🌟' },
              { rarity: 'Raro', color: 'from-blue-500 to-blue-600', emoji: '💎' },
              { rarity: 'Épico', color: 'from-purple-500 to-purple-600', emoji: '🔮' },
              { rarity: 'Legendario', color: 'from-yellow-500 to-amber-600', emoji: '👑' },
            ].map((card) => (
              <div
                key={card.rarity}
                className={`w-32 sm:w-40 h-48 sm:h-56 rounded-2xl bg-gradient-to-br ${card.color} p-4 flex flex-col justify-between shadow-xl transform hover:scale-105 transition-transform cursor-pointer`}
              >
                <div className="text-4xl sm:text-5xl text-center">{card.emoji}</div>
      ...
      <div id="como-funciona" className="py-20 bg-black/20">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-white/60 text-center mb-12 max-w-2xl mx-auto">
            Un sistema simple y divertido para coleccionar fotos únicas
          </p>
            ...
            {[
              {
                ...
                desc: 'Agrega Kwelps Coins a tu wallet usando PayPal o Sinpe Móvil (Costa Rica)',
                icon: '💳',
              },
              {
                step: '2',
                title: 'Compra Packs',
                desc: 'Compra packs de 3 fotos o fotos individuales en la tienda',
                icon: '📦',
              },
              {
                step: '3',
      ...
      <div className="py-20">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-white/60 text-center mb-12 max-w-2xl mx-auto">
            Cada foto tiene una rareza diferente con probabilidades únicas
          </p>
            ...
            {[
              {
                ...
                chance: '60%',
                desc: 'La rareza más común, perfecta para fusionar',
              },
              {
                rarity: 'Raro',
                ...
                chance: '25%',
                desc: 'Más difícil de conseguir, pero muy valiosa',
              },
              {
                rarity: 'Épico',
              ...
              },
              {
                ...
                chance: '5%',
                desc: 'La joya más preciada del álbum',
              },
            ].map((item) => (
              <div
                key={item.rarity}
      ...
      <div className="py-20 bg-gradient-to-br from-purple-900/50 to-pink-900/50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
            ¡Nunca te quedarás sin suerte!
          </h2>
          <p className="text-white/70 text-lg mb-8">
            Si no obtienes una carta legendaria en 20 compras, el sistema te garantiza una.
            Además, cada pack de 3 fotos siempre incluye al menos una carta rara o superior.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <div className="bg-white/5 rounded-xl px-6 py-4 border border-white/10">
              ...
              <p className="text-white/60 text-sm">Fusión de cartas</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-white/70 text-lg mb-8">
            Únete a miles de coleccionistas y completa tu álbum de Kwelps
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/register"
